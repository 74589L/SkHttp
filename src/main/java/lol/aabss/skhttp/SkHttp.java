    ...
    public void onEnable() {
        if (Bukkit.getPluginManager().getPlugin("Skript") != null) {
            ...
            try {
                ...
                try {
                    Class.forName("lol.aabss.skhttp.elements.http.Types", true, getClassLoader());
                    Class.forName("lol.aabss.skhttp.elements.discord.Types", true, getClassLoader());
                    Class.forName("lol.aabss.skhttp.elements.json.Types", true, getClassLoader());
                    Class.forName("lol.aabss.skhttp.elements.server.Types", true, getClassLoader());
                    Class.forName("lol.aabss.skhttp.elements.websocket.Types", true, getClassLoader());
                } catch (ClassNotFoundException e) {
                    LOGGER.error("Failed to preload SkHttp Types: " + e.getMessage());
                }
